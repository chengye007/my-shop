                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            ...
                            <div class="box-body">
                                <a href="/content/form" type="button" class="btn btn-sm btn-default"><i class="fa  fa-user-plus"></i>添加</a>&nbsp;&nbsp;&nbsp;
                                ...
                                <c:forEach items="${tbContents}" var="tbContent">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/content/form?id=${tbContent.id}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a>&nbsp;&nbsp;&nbsp;
